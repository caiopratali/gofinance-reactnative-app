...
export function Resume() {
  ...
  async function loadData() {
    ...
    const expensives = responseFormatted.filter((expensive: ResumeProps) => 
    expensive.type === 'down' 
    && new Date(expensive.date).getMonth() === selectedDate.getMonth() 
    && new Date(expensive.date).getFullYear() === selectedDate.getFullYear() 
    );

    const expensiveTotal = expensives.reduce((accumulator: number, expensive: TransactionCardDataProps) => {
    ...
    categories.forEach(category => {
      ...
      expensives.forEach((expensive: ResumeProps) => {
