...
export function Dashboard() {
  ...
  async function loadTransactions() {
    ...
    const lastTransactionEntries = getLastTransationDate(transactions, 'up');
    const lastTransactionExpansives = getLastTransationDate(transactions, 'down');
    const presentDay = Intl.DateTimeFormat('pt-BR', {
      day: '2-digit',
      month: 'long',
    }).format(new Date());

    const totalInterval = `01 à ${presentDay}`
